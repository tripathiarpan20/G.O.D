...
async def task_offer(
    ...
    try:
        ...
        if request.parameter_count is not None:
            # Example threshold - adjust based on your hardware
            if request.parameter_count > 13_000_000_000:  # e.g. 13B parameter limit
                return MinerTaskResponse(message="Model is too large for my hardware", accepted=False)
